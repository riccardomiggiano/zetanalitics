		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Analiticos de datos de Evaluacion",
									"targetURL": "#zetanalitics-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"zetanalitics-display": {
								"semanticObject": "zetanalitics",
								"action": "display",
								"description": "Analiticos de datos de Evaluacion",
								"title": "Analiticos de datos de Evaluacion",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zetanalitics",
									"url": sap.ui.require.toUrl("zetanalitics")
								}
							}
						}
					}
